...
if(is_array($file) && $file!="error")
{
	...
	$proof_details=getCustomerProofByFileId($file_id);
...
<tr>
  ...
  <td class="no_print">
             ...
             <a href="<?php echo $_SERVER['PHP_SELF'].'?action=delCustomerProof&id='.$file_id.'&state='.$proof['customer_proof_id']; ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
  </td>          
</tr>        
