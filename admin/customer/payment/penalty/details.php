...
<td>
                             ...
                             <?php  echo $penalty['days_paid']." Days"; ?>					
...
<td>
                             ...
                             <?php  echo $penalty['amount_per_day']." Rs"; ?>					
...
<td>
                             ...
                             <?php  echo "Rs. ".$penalty['amount_per_day']*$penalty['days_paid']; ?>					
...
<a href="<?php echo WEB_ROOT; ?>admin/customer/index.php?view=penaltyDetails&id=<?php echo $file_id; ?>&state=<?php echo $loan_id; ?>"><button class="btn btn-success" >Back</button></a>
</td>
</tr>
...
<div class="rasid">
<b> <i> the sum of Rupees :</b>  </i> <?php echo numberToWord((intval($penalty['days_paid'])*intval($penalty['amount_per_day'])))." Only"; ?>
</div>
...
<div class="lowerLeftDiv">
        ...
        <div class="rectangle">
            ...
            <div class="amount">
            <?php echo number_format((intval($penalty['days_paid'])*intval($penalty['amount_per_day'])))." /- "; ?>
            </div>
