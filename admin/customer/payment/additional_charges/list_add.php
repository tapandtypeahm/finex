...
<h4 class="headingAlignment"> Additioanl Charges to Customer </h4>
<?php 
				...
				<td>
                    ...
                    <option value="-1">-- Please Select --</option>
						...
						if($rasid_types!=false)
						{
							...
							{
						 ?>
                         <option value="<?php echo $rasid_type['rasid_type_id']; ?>"><?php echo $rasid_type['rasid_type_name']; ?></option>
                         <?php  }} ?>
                    </select>
                         </td>
</tr>
...
<td>Paid<span class="requiredField">* </span>  : </td>
				<td>
					<table>
               <tr><td><input type="radio"   name="paid" id="paid"  value="1" checked="checked"></td><td><label for="paid">Yes</label></td></tr>
            <tr><td><input type="radio"  id="not_paid" name="paid"  value="0" ></td><td><label for="not_paid">No</label></td>
               </tr> 
            </table>
                            </td>
</tr>
...
<a href="<?php echo WEB_ROOT ?>admin/customer/index.php?view=additionalPaymentDetails&id=<?php echo $file_id; ?>"><input type="button" value="Back" class="btn btn-success" /></a>
</td>
</tr>
