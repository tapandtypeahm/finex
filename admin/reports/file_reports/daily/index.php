...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['dFileReport']['remainder_array']=$reportArray;
		
		$_SESSION['dFileReport']['from']=$from;
		$_SESSION['dFileReport']['to']=$to;
		$_SESSION['dFileReport']['remainder_status']=$remainder_status;
		$_SESSION['dFileReport']['city_id']=$city_id;
		$_SESSION['dFileReport']['area_id_array']=$area_array;
		$_SESSION['dFileReport']['agency_id']=$agency_id;
		$_SESSION['dFileReport']['file_status']=$file_status;
