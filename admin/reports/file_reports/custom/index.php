...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cFileReport']['remainder_array']=$reportArray;
		
		$_SESSION['cFileReport']['from']=$from;
		$_SESSION['cFileReport']['to']=$to;
		$_SESSION['cFileReport']['remainder_status']=$remainder_status;
		$_SESSION['cFileReport']['city_id']=$city_id;
		$_SESSION['cFileReport']['area_id_array']=$area_array;
		$_SESSION['cFileReport']['agency_id']=$agency_id;
		$_SESSION['cFileReport']['file_status']=$file_status;
