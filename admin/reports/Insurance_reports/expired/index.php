...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=expiredInsuranceReports($from,$to,$city_id,$area_id_string);
		
		
		$_SESSION['einsuranceReport']['insurance_array']=$reportArray;
		$_SESSION['einsuranceReport']['from']=$from;
		$_SESSION['einsuranceReport']['to']=$to;
		$_SESSION['einsuranceReport']['city_id']=$city_id;
		$_SESSION['einsuranceReport']['area_id']=$area;
		$_SESSION['einsuranceReport']['area_id_array']=$area_array;
