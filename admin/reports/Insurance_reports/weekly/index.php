...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['minsuranceReport']['insurance_array']=$reportArray;
		$_SESSION['minsuranceReport']['from']=$from;
		$_SESSION['minsuranceReport']['to']=$to;
		$_SESSION['minsuranceReport']['city_id']=$city_id;
		$_SESSION['minsuranceReport']['area_id_array']=$area_array;
