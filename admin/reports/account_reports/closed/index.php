...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['clAccountReports']['file_array']=$reportArray;
		
		$_SESSION['clAccountReports']['from']=$from;
		$_SESSION['clAccountReports']['to']=$to;
		$_SESSION['clAccountReports']['remainder_status']=$remainder_status;
		$_SESSION['clAccountReports']['city_id']=$city_id;
		$_SESSION['clAccountReports']['area_id_array']=$area_array;
		$_SESSION['clAccountReports']['agency_id']=$agency_id;
		$_SESSION['clAccountReports']['file_status']=$file_status;
