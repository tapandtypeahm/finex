...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalAccountReports($from,$to,$city_id,$area_id_string,$file_status,$agency_id);
		$_SESSION['cAccountReport']['remainder_array']=$reportArray;
		
		$_SESSION['cAccountReport']['from']=$from;
		$_SESSION['cAccountReport']['to']=$to;
		$_SESSION['cAccountReport']['city_id']=$city_id;
		$_SESSION['cAccountReport']['area_id_array']=$area_array;
		$_SESSION['cAccountReport']['agency_id']=$agency_id;
		$_SESSION['cAccountReport']['file_status']=$file_status;
