...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['dAccountReport']['remainder_array']=$reportArray;
		
		$_SESSION['dAccountReport']['from']=$from;
		$_SESSION['dAccountReport']['to']=$to;
		$_SESSION['dAccountReport']['remainder_status']=$remainder_status;
		$_SESSION['dAccountReport']['city_id']=$city_id;
		$_SESSION['dAccountReport']['area_id']=$area;
		$_SESSION['dAccountReport']['area_id_array']=$area_array;
		$_SESSION['dAccountReport']['file_status']=$file_status;
