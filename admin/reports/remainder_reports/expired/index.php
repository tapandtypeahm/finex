...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['eRemainderReport']['remainder_array']=$reportArray;
		
		$_SESSION['eRemainderReport']['from']=$from;
		$_SESSION['eRemainderReport']['to']=$to;
		$_SESSION['eRemainderReport']['remainder_status']=$remainder_status;
		$_SESSION['eRemainderReport']['city_id']=$city_id;
		$_SESSION['eRemainderReport']['area_id_array']=$area_array;
		$_SESSION['eRemainderReport']['agency_id']=$agency_id;
		$_SESSION['eRemainderReport']['file_status']=$file_status;
	...
	if(isset($_POST['remainder_status']))
		...
		$reportArray=generalRemianderReports($from,$to,$remainder_status,$city_id,$area_id,$file_status,$agency_id);
		
		$_SESSION['eRemainderReport']['emi_array']=$reportArray;
		
		$_SESSION['eRemainderReport']['from']=$from;
		$_SESSION['eRemainderReport']['to']=$to;
		$_SESSION['eRemainderReport']['remainder_status']=$remainder_status;
		$_SESSION['eRemainderReport']['city_id']=$city_id;
		$_SESSION['eRemainderReport']['area_id']=$area;
		$_SESSION['eRemainderReport']['agency_id']=$agency_id;
		$_SESSION['eRemainderReport']['file_status']=$file_status;
	...
	else if($_GET['action']=='fromHomeExpired')
	{
		...
		$_SESSION['eRemainderReport']['from']=$from;
		$_SESSION['eRemainderReport']['to']=$to;
		$_SESSION['eRemainderReport']['win']=$win;
		$_SESSION['eRemainderReport']['city_id']=$city_id;
		$_SESSION['eRemainderReport']['area_id_array']=$area_array;
		$_SESSION['eRemainderReport']['agency_id']=$agency_id;
		$_SESSION['eRemainderReport']['file_status']=2;
