...
<td>Area : </td>
				<td>
					<input type="text" name="area" class="city_area" id="city_area1" placeholder="Only Letters" value="<?php if(isset($_SESSION['dRasidReport']['area_id'])) echo $_SESSION['dRasidReport']['area_id']; ?>" />
                            </td>
</tr>
...
<td>
	...
	<input  type="radio" name="file_status" id="both"  <?php if(!isset($_SESSION['dRasidReport']['payment_mode']) || ($_SESSION['dRasidReport']['payment_mode']!=1 && $_SESSION['dRasidReport']['payment_mode']!=2)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">Both</label>
</td>
</tr>
<tr>
