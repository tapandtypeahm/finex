...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalLoanStarterReports($from,$to,$win_gt,$win_lt,$emi_gt,$emi_lt,$balance_gt,$balance_lt,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string);
		
		$_SESSION['lsEMIReport']['emi_array']=$reportArray;
		$_SESSION['lsEMIReport']['from']=$from;
		$_SESSION['lsEMIReport']['to']=$to;
		$_SESSION['lsEMIReport']['win_gt']=$win_gt;
		$_SESSION['lsEMIReport']['win_lt']=$win_lt;
		$_SESSION['lsEMIReport']['emi_gt']=$emi_gt;
		$_SESSION['lsEMIReport']['emi_lt']=$emi_lt;
		$_SESSION['lsEMIReport']['balance_gt']=$balance_gt;
		$_SESSION['lsEMIReport']['balance_lt']=$balance_lt;
		$_SESSION['lsEMIReport']['city_id']=$city_id;
		$_SESSION['lsEMIReport']['area_id_array']=$area_array;
		$_SESSION['lsEMIReport']['broker_id_array']=$broker_array;
		$_SESSION['lsEMIReport']['agency_id']=$agency_id;
		$_SESSION['lsEMIReport']['file_status']=$file_status;
