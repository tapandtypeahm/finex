...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		...
		$result=insertVehicleDealer($_POST["name"], $_POST["address"], $_POST["city"], $_POST["company"], $_POST["contactNo"]);
		if($result=="success")
				{
...
$jsArray=array("jquery.validate.js","validators/vehicleDealers.js");
