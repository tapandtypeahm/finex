...
<h4 class="headingAlignment no_print">Edit Vehicle Company</h4>
<?php 
					...
					<select id="dealer" name="vehicle_company_id">
                        ...
                        <?php
                            ...
                            foreach($companies as $super)
                             ...
                             <option value="<?php echo $super['vehicle_company_id'] ?>" <?php if($model['vehicle_company_id']==$super['vehicle_company_id']) echo "selected"; ?>><?php echo $super['company_name'] ?></option					>
                             <?php } ?>
...
<td>
<input type="hidden" name="lid"  value="<?php echo $model['model_id']; ?>"/>
<input type="text" name="name" id="txtName" value="<?php echo $model['model_name']; ?>"/>
</td>
</tr>
