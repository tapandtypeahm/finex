...
<h4 class="headingAlignment no_print">Search Customer / File Details</h4>
...
<td>
<input type="text" name="agreementNo" id="agreementNo" placeholder="Only letters and numbers" autocomplete="off"/>
</td>
</tr>
...
<td>File Number : </td>
				<td>
				 <input type="text"  name="fileNumber" id="fileNumber" placeholder="Only Letters and numbers" autocomplete="off"/>	
                 </td>
</tr>
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td><?php echo $reg_no; ?>
             ...
             <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/index.php?view=details&id='.$file_id['file_id'] ?>"><button title="Select" class="btn btn-warning">select</button></a>
            </td>
        </tr>
         <?php }}?>
         </tbody>
