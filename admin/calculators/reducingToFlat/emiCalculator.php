...
<h4 class="headingAlignment no_print">Reducing to Flat Rate Calculator</h4>
...
<td>
<input type="text" name="amount" id="amount" autocomplete="off" placeholder="only Digits"  value="<?php if(isset($_SESSION['remiCalc']['amount'])) echo $_SESSION['remiCalc']['amount'] ?>"/>
</td>
</tr>
...
<td>
<input type="text" name="duration" id="duration" placeholder="only Digits " value="<?php if(isset($_SESSION['remiCalc']['duration'])) echo $_SESSION['remiCalc']['duration'] ?>"/> 
</td>
</tr>
...
<td>
<input type="text" name="reducing_roi" id="roi" placeholder="only Digits" value="<?php if(isset($_SESSION['remiCalc']['reducing_roi'])) echo $_SESSION['remiCalc']['reducing_roi'] ?>"/> 
</td>
</tr>
...
<td>
<input disabled="disabled" type="text" name="emi" value="<?php if(isset($_SESSION['remiCalc']['emi'])) echo $_SESSION['remiCalc']['emi'] ?>"   />
</td>
</tr>
...
<td>
<input disabled="disabled" type="text" name="roi"  value="<?php if(isset($_SESSION['remiCalc']['roi'])) echo $_SESSION['remiCalc']['roi'] ?>" />
</td>
</tr>
...
<td>
<input disabled="disabled" type="text" name="IRR" value="<?php if(isset($_SESSION['remiCalc']['irr'])) echo $_SESSION['remiCalc']['irr'] ?>"  />
</td>
</tr>
 ...
 <?php
		if(isset($_SESSION['remiCalc']['princ_interest_table']) && is_array($_SESSION['remiCalc']['princ_interest_table']))
		$full_table=$_SESSION['remiCalc']['princ_interest_table'];
		$no=0;
